  ...
  <main class="main">
          ...
          <div class="container"> 
            <div class="row gy-4">
              ...
              <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="card">
                  <img src="assets/img/gambar/medium.png" class="img-fluid" alt="">
                  <h3>Medium</h3>
                </div>
              </div>
    ...
    <!-- order button -->
    <section id="order" class="order section bg-custom mx-auto px-auto">
      <div class="container">
        <div class="row">
          <div id="order_shape" class="col-lg-12 text-center p-5 bg-white shadow rounded text-center">
            <h2>Ready to Order?</h2>
            <p>Click the button below to place your order.</p>
            <a href="<?php echo site_url("order")?>" class=" btn btn-primary mb-5">Order Now</a>
          </div>
        </div>
      </div>
